...
export interface ComponentItem<Tag extends HTMLElement = HTMLElement> {
    id: string;
...
export interface Component<Type = unknown, Tag extends HTMLElement = HTMLElement, Items = never> {
    id?: string;
    type: Type;
    label?: React.ReactNode;
    content?: React.ReactNode;
    ...
    attributes?: Partial<React.HTMLProps<Tag>>;
    items?: (Items extends never ? Items : Items[]);
    conditions?: Conditional.Condition | Conditional.Items;
    ref?: React.Ref<Tag>;
}
export interface FormComponent<Type = unknown, Tag extends HTMLElement = HTMLElement, Items = never, Value = Meta.Value | Meta.Value[]> extends Omit<Component<Type, Tag, Items>, 'label'> {
    id: string;
    name: string;
