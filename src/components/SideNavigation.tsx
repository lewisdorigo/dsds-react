...
/**
 * @param {DSDS.Component.SideNavigation.List} props - Properties for the element
 * @returns {JSX.Element} - The element
 */
const SideNavigationList:React.FC<
    DSDS.Component.SideNavigation.List
...
/**
 * @param {DSDS.Component.SideNavigation} props - Properties for the element
 * @returns {JSX.Element} - The element
 */
const SideNavigation:React.FC<
    Omit<DSDS.Component.SideNavigation, 'type'>
